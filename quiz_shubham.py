...
def action_perform():
    ...
    print("\t\tWelcome to Quiz")
    print("---------------------------------------------------------------------------------------")   
    choice = {1:'press 1 for login',2:'press 2 for register: ',3:'Exit'}
